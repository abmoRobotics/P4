...
echo_and_run cd "/home/anton/P4_catkin_ws/src/ds4_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/anton/P4_catkin_ws/src/ds4_driver/setup.py" \
     \
    build --build-base "/home/anton/P4_catkin_ws/build/ds4_driver" \
    install \
    --root="${DESTDIR-/}" \
